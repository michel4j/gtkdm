...
class ScaleControl(Gtk.EventBox):
    ...
    def on_realize(self, obj):
        ...
        self.scale.add_mark(self.minimum, Gtk.PositionType.TOP, '{}'.format(self.minimum))
        self.scale.add_mark(self.maximum, Gtk.PositionType.TOP, '{}'.format(self.maximum))
